...
namespace wf07_myexplorer
{
    public partial class FrmExplorer : Form
    {
        ...
        private void FrmExplorer_Load(object sender, EventArgs e)
        {
            ...
            CboView.SelectedIndex = 0; // View.Details 로 초기화 
         }
        ...
        // sender 자기 자신 객체 내용, e 이벤트와 관련된 속성들이 포함 
        /// <summary>
        /// 트리뷰 노드 확장하기 전 이벤트 
        /// </summary>
        ...
        private void SetLsvFolder(string fullPath)
        {
            ...
            {
                MessageBox.Show("리스트 뷰 오류발생", "오류", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        /// <summary>
        /// 파일 확장자에 따라 아이콘을 변경
        ...
        private void TxtPath_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)  // 키보드 엔터키를 누르면
            {
                ...
                {
                    MessageBox.Show("경로를 찾을 수 없습니다. 맞춤법을 확인하고 다시 시도하세요.", "나의 탐색기",
