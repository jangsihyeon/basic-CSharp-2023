...
namespace wf14_winforms_thread
{
    public partial class FrmMain : Form
    {
        ...
        {
            BackgroundWorker worker= sender as BackgroundWorker;   // 인자값으로 BackgroundWorker 생성 얕은 복사 - Worker랑 주소 참소 
        ...
        {
            // 파라미터 arg 0~91 사이 , 91보다 크면 long에서 overfolw 발생 
            if( arg < 0 || arg > 91 )
            {
            ...
            else
            {
                ...
                {
                    // arg만 계산에 필요한 매개 변수 임 나머지 worker랑 e는 중간에 취소할때 필요한 backworker 복사본
        ...
        {
           // BtnStart.Enabled = false;  // 시작 버튼은 종료시 까지 누르지 못함 
